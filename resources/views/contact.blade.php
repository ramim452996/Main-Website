...
<head>
    ...
    <title>যোগাযোগ ও হেল্পডেস্ক • KushtiaExpress</title>
    ...
    <header class="navbar">
        <div class="container nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="{{ route('contact.page') }}" class="nav-link active">যোগাযোগ (Contact)</a></li>
            </ul>
        ...
        <div class="container">
            <div class="footer-bottom" style="border: none; padding: 0;">
                ...
                <div style="display: flex; gap: 18px;">
                    ...
                    <a href="{{ route('order.page') }}">অর্ডার ট্র্যাকিং</a>
                </div>
            </div>
        </div>
    </footer>
