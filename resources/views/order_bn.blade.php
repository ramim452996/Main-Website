...
<head>
    ...
    <title>অর্ডার ট্র্যাকিং ও অর্ডারসমূহ (Orders) • কুষ্টিয়া এক্সপ্রেস</title>
    ...
    <header class="navbar">
        <div class="container nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="{{ route('order.bn') }}" class="nav-link active">অর্ডার ট্র্যাকিং (বাংলা)</a></li>
                    ...
                    <div>
                        ...
                        <div class="timeline-tracker" id="orderPageTimeline">
                            <div class="timeline-step completed">
                                ...
                                <div class="step-title">অর্ডার গৃহীত হয়েছে ও পেমেন্ট সম্পন্ন</div>
        ...
        <div class="container">
            <div class="footer-bottom" style="border: none; padding: 0;">
                ...
                <div style="display: flex; gap: 18px;">
                    ...
                    <a href="{{ route('contact.bn') }}">যোগাযোগ পেইজ (বাংলা)</a>
                    <a href="{{ route('order.page') }}">English Version</a>
                </div>
            </div>
        </div>
    </footer>
